...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('total_requests', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('users', sa.Column('monthly_requests', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('users', sa.Column('request_count_reset_date', sa.DateTime(timezone=True), nullable=True))
