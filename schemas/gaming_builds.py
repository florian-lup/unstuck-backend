"""Gaming Builds schemas for request/response validation."""
...
class GamingBuildsRequest(BaseModel):
    """Request schema for Gaming Builds queries."""

    query: str = Field(
        ..., min_length=1, max_length=500, description="Gaming Builds query"
    )
    game: str = Field(
...
class GamingBuildsResponse(BaseModel):
    """Response schema for Gaming Builds queries."""
