...
from core.subscription import check_lore_access, get_request_limit_info
...
async def gaming_lore(
    ...
    request: Request,
    internal_user: User = Depends(check_lore_access),  # noqa: B008
    ...
    """
    try:
        # User access already checked by check_lore_access dependency
